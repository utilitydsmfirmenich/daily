...
async function ensureTables(db: D1Database) {
  ...
  try {
    ...
    await db.prepare("INSERT OR IGNORE INTO pids (pid, display_name) VALUES ('AGSB', 'Agus Sobarna (AGSB)'), ('MUKB', 'M. Ulin Nuha (MUKB)'), ('IKJA', 'Iksan Jaelani (IKJA)'), ('AHIK', 'Ahmad Hikmat (AHIK)')").run();
